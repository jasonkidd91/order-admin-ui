...
import { createDelivery, getStoreDetails } from '../redux/deliverySlice';
...
const DeliveryCreate = () => {
  ...
  const createDeliveryHandler = () => {
    dispatch(createDelivery(auth, deliveryState));
  };
        ...
        <CCardBody>
          ...
          <CRow>
            <CCol xs={12} className="text-right">
              <CButton color="success" className="px-4 mr-4" onClick={createDeliveryHandler}>
                Create
              </CButton>
